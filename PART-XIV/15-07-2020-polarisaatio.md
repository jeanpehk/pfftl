...
voivat olla [dynamiikaltaan](../PART-II/29-06-2020-dynamiikka.md)
...
ja negatiiviset laiskaa, tai [coinduktiivista](../PART-V/05-07-2020-coinduktiiviset-tyypit.md).
Lisäämällä vielä tyypit polarisaation muutokselle (polarity shift) ja operaatiot
laskennan suorittamiselle voidaan laskentaa suorittaa ohjelmoijan
määräämällä tavalla.
...
[sisäkkäinen parallelisaatio](../PART-XV/16-07-2020-sisakkainen-parallelisaatio.md).
