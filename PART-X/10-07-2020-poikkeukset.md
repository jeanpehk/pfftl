...
virheisiin poikkeuksen käsittelijässä.
...
Kolmannessa tavassa virheet esitetään [sum tyypeillä](../PART-IV/04-07-2020-sum-tyypit.md).
...
Tätä kutsutaan [dynaamiseksi klassifikaatioksi](../PART-XII/13-07-2020-dynaaminen-klassifikaatio.md)
